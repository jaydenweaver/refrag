...
beforeMount(async () => {
  WebGL2RenderingContext.prototype.texElementImage2D = function(target, level, internalformat, format, type, _element) {
    this.texImage2D(
      target,
      level,
      internalformat,
  ...
  Object.defineProperty(HTMLCanvasElement.prototype, "requestPaint", {
    ...
    value() {
      ...
      if (children.length > 0 && this.onpaint) {
        this.onpaint({ changedElements: children });
      }
    }
  });
});
...
const C__Users_Jayden_projects_refrag_src_components_HtmlShader_index_js_HtmlShader = () => __vitePreload(() => import('./index-Ck0gGIXK.js'),true              ?[]:void 0).then((mod) => mod.HtmlShader);
__pwRegistry.initialize({ C__Users_Jayden_projects_refrag_src_components_HtmlShader_index_js_HtmlShader });

export { reactExports as a, getDefaultExportFromCjs as g, requireReactDom as r };
//# sourceMappingURL=index-C-9igzxv.js.map
