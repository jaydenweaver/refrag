  ...
  return (
    <>
      ...
      <div style={{ ...TEXT_STYLE, display: "flex", flexDirection: "column", alignItems: "center", gap: "2rem", padding: "0", maxWidth: "50ch" }}>
        ...
        <div>
          you can also create your own shaders via the sidebar as well.
        </div>
        <div style={{ marginBottom: "-1.5rem" }}>
          here is an {'<img>'} of a red panda. 😴
        </div>
        <img
        ...
        />
        <div style={{ marginBottom: "-1.5rem" }}>
          here is an animated {'<canvas>'}.
        </div>
        <AnimatedCanvas />
        <div style={{ marginBottom: "-1.5rem" }}>
          here is an element with animations (try hovering over it).
        </div>
      </div>
